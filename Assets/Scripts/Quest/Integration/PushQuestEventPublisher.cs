...
namespace Quest.Integration
{
    ...
    public sealed class PushQuestEventPublisher : MonoBehaviour
    {
        [SerializeField] private PushControllableWorldObject _target;
        [SerializeField] private SceneEventBusProvider _eventBusProvider;
        [SerializeField] private string _sourceId = "push_object";
        [SerializeField] private string _targetId = "push_object";
        ...
        private void Reset()
        {
            if (_target == null)
            {
                _target = GetComponent<PushControllableWorldObject>();
            }
        }
    }
}
